...
<div id="content">
  ...
  <div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-3 text-gray-800">{{ $buku->judul_buku }}</h1>
    <!-- DataTales Example -->
        ...
        <form method="POST" action="{{ route('buku.update', $buku->id) }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('judul_buku') is-invalid @enderror" id="judul_buku"
              name="judul_buku" placeholder="Judul Buku" value="{{ $buku->judul_buku }}">
            @error('judul_buku')
          ...
          <div class="form-group">
            ...
            <input type="text" id="penulis" class="form-control @error('penulis') is-invalid @enderror" id="penulis"
              name="penulis" placeholder="Jumlah Buku" value="{{ $buku->penulis  }}">
            @error('penulis')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group">
            ...
            <input type="text" id="tahun_terbit" class="form-control @error('tahun_terbit') is-invalid @enderror"
              id="tahun_terbit" name="tahun_terbit" placeholder="Harga Buku" value="{{ $buku->tahun_terbit  }}">
            @error('tahun_terbit')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group">
            ...
            <input type="text" id="kode_buku" class="form-control @error('kode_buku') is-invalid @enderror"
              id="kode_buku" name="kode_buku" placeholder="Harga Buku" value="{{ $buku->kode_buku  }}">
            @error('kode_buku')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group">
            ...
            <input type="text" id="stok_buku" class="form-control @error('stok_buku') is-invalid @enderror"
              id="stok_buku" name="stok_buku" placeholder="Harga Buku" value="{{ $buku->stok_buku  }}">
            @error('stok_buku')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
          ...
          <div class="form-group">
            ...
            <input type="file" id="image" class="form-control-file" id="nama_gambar" name="nama_gambar"
              value="{{ $buku->nama_gambar }}" placeholder="Cover Buku">
            @error('nama_gambar')
